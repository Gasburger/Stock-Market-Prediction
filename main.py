...
with open('/Users/utsavmitra/Documents/Stock_Market/Data/DJIA_data.csv', 'rb') as csvfile:
...
for year in years:
    for month in months:
        file_str = '/Users/utsavmitra/Documents/Stock_Market/Data/nytimes/' + str(year) + '-' + '{:02}'.format(month) + '.json'
...
interpolated_df.to_pickle('/Users/utsavmitra/Documents/Stock_Market/Data/ten_year_filtered_data.pkl')  


# Save pandas frame in csv form
interpolated_df.to_csv('/Users/utsavmitra/Documents/Stock_Market/Data/ten_year_filtered_data.pkl',
                       sep='\t', encoding='utf-8')



# Reading the data as pickle file
dataframe_read = pd.read_pickle('/Users/utsavmitra/Documents/Stock_Market/Data/ten_year_filtered_data.pkl')
